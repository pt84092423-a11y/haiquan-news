...
import React, { getSiteSetting, parseJsonSetting, upsertSetting, uploadImage } from '@/lib/supabase';
import React, { DEFAULT_COMMAND_DATA, RANKS, type ActivityMilestone, type CommandData, type Commander } from '../CommandPage';
