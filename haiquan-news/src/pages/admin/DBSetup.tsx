  ...
  return (
    <AdminLayout title="Cài đặt Database">
      ...
      <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-xl p-5">
        <h3 className="font-bold text-[14px] text-yellow-800 mb-1">⚠️ Lưu ý quan trọng</h3>
        <p className="text-[13px] text-yellow-700">
          Chạy các bước <b>theo đúng thứ tự</b>. Bước 3a–3d có thể chạy nhiều lần mà không bị lỗi (đều dùng <code className="bg-yellow-100 px-1 rounded">IF NOT EXISTS</code>).
          Bước 4 chỉ chạy <b>sau khi đã tạo bucket</b> <code className="bg-yellow-100 px-1 rounded">post-images</code> trong Storage.
        </p>
      </div>
    </AdminLayout>
  );
