...
import React, { getAllCategories, searchPostsFull, type Category, type Post } from '@/lib/supabase';
  ...
  return (
    <>
      ...
      <main className="container mx-auto max-w-[1200px] px-4 pt-8 pb-16">
        <div className="mb-8">
          <h1 className="font-['Playfair_Display',serif] text-[30px] font-black text-[#0059b2] mb-6 uppercase tracking-tight flex items-center gap-2">
